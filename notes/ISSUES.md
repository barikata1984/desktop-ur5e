...
- ホームポーズが実験用水平姿勢に変更されたままになっている: `_ARM_HOME_QPOS = [1.031643, -1.461450, 2.562062, -4.242204, -1.031607, 0.000245]`. push パイプライン作業前に同定初期姿勢 `[1.324683, -1.468515, 1.368294, -1.470575, -1.570796, -0.246113]` に戻すか, 設定可能にする必要がある
